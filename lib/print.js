...
export default async function (m, conn = { user: {} }) {
  if (m.messageStubType == WAMessageStubType.CIPHERTEXT) return console.log("CIPHER TEXT DETECTED!")
...
${chalk.green('%s')} ${chalk.yellow('%s%s')} ${chalk.blueBright('ke')} ${chalk.green('%s')} ${chalk.black(chalk.bgYellow('%s'))}
`.trim(),
    me + ' ~' + conn.user.name,
